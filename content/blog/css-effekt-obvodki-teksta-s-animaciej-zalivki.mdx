...
Хотите добавить интересный CSS эффект на&nbsp;вашем сайте? Обводка текста с&nbsp;заливкой при наведении выглядит стильно и&nbsp;делается на&nbsp;чистом CSS,я&nbsp;ее&nbsp;использовал для ссылок в&nbsp;меню. Не, ну&nbsp;а&nbsp;чо? Красиво&nbsp;же. Вот пример кода на&nbsp;SCSS, медиазапросы для адаптивности напишете сами, у&nbsp;меня тут миксины, короче, кто понял тот понял:
